...
class LingotekApi {
  ...
  public function addContentDocument(LingotekTranslatableEntity $translatable_object, $with_targets = FALSE) {
    ...
    if ($project_id) {
      ...
      // If the document is empty, also return without uploading
      if ($translatable_object->isEmpty()) {
          drupal_set_message(t('Document was not uploaded to Lingotek because it is empty.'), 'warning');
          return FALSE;
      }
