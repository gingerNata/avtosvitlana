 ...
 * @see html.tpl.php
 */
function kickstart_subtheme_preprocess_html(&$variables) {
  // Add conditional stylesheets for IE
  $theme_path = drupal_get_path('theme', 'kickstart_subtheme');
 ...
 */
function kickstart_subtheme_css_alter(&$css) {
  global $language;
 ...
 * Preprocess field.
 */
function kickstart_subtheme_preprocess_field(&$variables) {
 ...
 */
function kickstart_subtheme_preprocess_node(&$variables) {
